...
if (isset($_GET["e"])) {
    ...
    $update = mysqli_query($conn, "SELECT * FROM posts WHERE id = '$id'");
...
if (isset($_POST['edit'])) {
    ...
    $sql = "UPDATE posts SET topic = '$topic' , detail = '$detail',img=? where id = '$id'";
                    ...
                    <div class="container">
                        <form action="edit.php" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                <label>Topic:</label>
                                <input type="text" name="topic" class="form-control" value="<?php echo $up["topic"]; ?>">
                            </div>
                            <div class="form-group">
                                <label>Details:</label>
                                <textarea type="text" name="detail" class="form-control" style="resize: none;height: 200px;"><?php echo $up["detail"]; ?></textarea>
                            </div>
                            <button class="btn btn-primary w-100 mt-5" type="submit" name="edit">Edit</button>
                        </form>
                    </div>
                </div>
            </div>
